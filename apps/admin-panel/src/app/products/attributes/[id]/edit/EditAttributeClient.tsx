...
import { updateAttribute, updateAttributeStatus } from '@/services/attributes';
...
export function EditAttributeClient({ id }: EditAttributeClientProps) {
  ...
  const handleSubmit = async (data: any) => {
    try {
      ...
      if (attribute && formattedData.isActive !== undefined && formattedData.isActive !== attribute.isActive) {
        ...
        await updateAttributeStatus(id, formattedData.isActive);
