...
import { PaymentService, CreatePaymentGatewayParams } from '@/services/payment.service';
...
export default function NewPaymentGatewayPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      const gatewayData: CreatePaymentGatewayParams = {
        ...data,
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Add New Payment Gateway</h1>
        <Button 
          variant="outline" 
          onClick={() => router.back()}
        >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="isEnabled">
                  {defaultValues.isEnabled ? 'Enabled' : 'Disabled'}
                </Label>
              </div>
            </div>
        ...
        <div className="flex justify-end gap-4">
          ...
          >
            {isSubmitting ? 'Creating...' : 'Create Payment Gateway'}
          </Button>
        </div>
      </form>
    </div>
